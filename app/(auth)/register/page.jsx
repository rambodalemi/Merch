...
const RegisterForm = () => {
  ...
  const onSubmit = async (formData) => {
    ...
    const data = await mutateRegister(formData);
    console.log(data);
  };

  useEffect(() => {
    if (isSuccess) {
      toast.success("Check your email. Your registration has been successful.");
      redirect("/otp");
    }
    if (error) {
      ...
      <div className="relative h-screen dark:bg-black flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className="p-4 lg:p-8 h-full flex items-center">
          <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
            ...
            <p className="px-8 text-white text-center justify-between inline text-sm text-muted-foreground">
